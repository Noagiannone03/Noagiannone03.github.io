...
const message = "bonjour et bienvenu a tous.aujourd'hui nous allons parler de chat gpt et de sa puissance.en effet cet outil est d'un puissance rocampbolesque puisque qu'il peut tout faire de la plus peitite chose jusqu'au relveé de carte bancaire.c'est incroyable";
const backgroundcolorvar = "#ffffff;
const textcolorvar = "#000000;
const fontfamilyvar = "Arial";
